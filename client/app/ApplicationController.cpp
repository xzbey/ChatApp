    ...
    : QObject(parent)
{
    ...
    connect(chatService, &ChatService::messageReceived, this, &ApplicationController::messageReceived);
    connect(chatService, &ChatService::broadcastReceived, this, &ApplicationController::broadcastReceived);
